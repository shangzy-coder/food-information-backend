package org.sinobridge.common.mybatis.handler;
...
import org.sinobridge.common.mybatis.enums.DataScopeType;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://sino-bridge.com/Submachine/issues/IB4CS4
