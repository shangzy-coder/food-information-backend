...
import org.sinobridge.common.core.service.WorkflowService;
...
public class SysTenantServiceImpl implements ISysTenantService {
    ...
    private LambdaQueryWrapper<SysTenant> buildQueryWrapper(SysTenantBo bo) {
        ...
        lqw.like(StringUtils.isNotBlank(bo.getDomain()), SysTenant::getDomainName, bo.getDomain());
