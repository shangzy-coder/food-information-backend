package org.sinobridge.generator.util;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("org.sinobridge.common.translation.annotation.Translation");
                importList.add("org.sinobridge.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
